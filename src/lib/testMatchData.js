...
export const TEST_MATCH_ENABLED = process.env.REACT_APP_TEST_MATCH_ENABLED === 'true';

export const TEST_MATCH = TEST_MATCH_ENABLED ? {
...
export const TEST_PREDICTION_CARD = TEST_MATCH_ENABLED ? {
  date: '2026-05-30',
  matches: [
    {
      homeTeam: 'Paris Saint-Germain',
